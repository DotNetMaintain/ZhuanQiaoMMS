<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectMaterial_Index.aspx.cs" Inherits="RM.Web.RMBase.SysBaseInfo.SelectMaterial_Index" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            iframeresize();
            Loading(true);
            $("#target_right").attr("src", "SelectMaterial_List.aspx");
            $("#target_left").attr("src", "SelectMaterial_Left.aspx");
        })
        /**自应高度**/
