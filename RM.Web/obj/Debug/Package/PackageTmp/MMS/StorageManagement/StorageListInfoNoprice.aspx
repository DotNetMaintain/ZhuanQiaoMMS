<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StorageListInfoNoprice.aspx.cs" Inherits="RM.Web.MMS.StorageManagement.StorageListInfoNoprice" %>
                      ...
                      <PagerSettings Mode="NextPreviousFirstLast" FirstPageText="首页" 
                        ...
                        <Columns>
                          ...
                          <asp:BoundField DataField="Material_Specification" HeaderText="物料规格" SortExpression="Material_Specification" />
                            ...
                            <asp:BoundField DataField="SeldPrice" HeaderText="出货单价" SortExpression="SeldPrice" />
