...
<body style="overflow: auto">
                        ...
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example" id="tablediv">
                                    <thead>
                                        <tr>
                                            <th><asp:LinkButton ID="orderbcode" runat="server" OnClick="orderbcode_Click">领料单号</asp:LinkButton></th>
                                            <th><asp:LinkButton ID="orderbygys" runat="server" OnClick="orderbygys_Click">领料部门</asp:LinkButton></th>
                                            <th>入库日期</th>
                                        </tr>
                                    </thead>
                                    <tbody>
    ...
    <script>   
        function store(id) {
            var str = id + " ";
            var url = "/mms/StorageManagement/MaterailRequisitiondetail.aspx?ID=" + str;
            top.openDialog(url, 'MaterailRequisitiondetail', '领料详细信息管理', 1200, 700, 50, 50);
        }</script>
</body>
</html>
