<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectClient.aspx.cs" Inherits="RM.Web.RMBase.SysBaseInfo.SelectClient" %>
                                ...
                                <tr>
                                    <td>
                                        <cc1:GridView ID="dgvInfo" runat="server" AutoGenerateColumns="False"  Width="100%"
                                                      DataKeyNames="ClientCode" EmptyDataText="没有可显示的数据记录。" 
                                                      AllowPaging="false" 
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="ValueCode" HeaderText="客户代码" 
                                                                SortExpression="ValueCode" />
                                                <asp:BoundField DataField="ValueName" HeaderText="客户简称" 
