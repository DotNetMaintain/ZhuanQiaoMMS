<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectMaterial_Left.aspx.cs" Inherits="RM.Web.RMBase.SysBaseInfo.SelectMaterial_Left" %>
    ...
    <script type="text/javascript">
        ...
        function GetClickValue() {
            $(".strTree li div").click(function () {
                ...
                var path = 'SelectMaterial_List.aspx?MaterialType_ID=' + id;
