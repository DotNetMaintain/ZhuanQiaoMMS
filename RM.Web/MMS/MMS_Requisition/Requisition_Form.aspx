        ...
        <script  type="text/javascript">
            ...
            function GetButtonShow() {
               ...
               //     //bt.style.display = true;
                //}
                if (parseInt(myDate.getHours()) > 14 && parseInt(myDate.getMinutes())) {
                    alert("下午2:30后不能领料");
                    document.getElementById("btnSave").disabled = true;
...
//                window.open("../../RMBase/SysBaseInfo/SelectMaterial_Index.aspx");
              //  parent.location.href("../../RMBase/SysBaseInfo/SelectMaterial_Index.aspx");
                ...
                if (localStorage.getItem('key')!=null) {
                    document.getElementById("hidProductCode").value = localStorage.getItem("key");
                    document.getElementById("hidProductName").value = localStorage.getItem("name");
                    document.getElementById("hidPrice").value = localStorage.getItem("price");
                    document.getElementById("hidUseQuantity").value = localStorage.getItem("usequantity");

                    document.getElementById("txtProductCode").value = localStorage.getItem("key");
                    document.getElementById("txtShortName").value = localStorage.getItem("name");
                    document.getElementById("txtPrice").value = localStorage.getItem("price");
                    document.getElementById("txtUseQuantity").value = localStorage.getItem("usequantity");
                }
