<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MatStorequerydetails.aspx.cs" Inherits="RM.Web.MMS.StorageManagement.MatStorequerydetails" %>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                        入库金额：<input id="count" style="border:none;background-color:#f3f3f4;" readonly="true"/>
                    <div class="ibox-content" id="tablediv">
                        
                        <table style="font-size:15px; border:1px black solid;width:45%">
                            <tr style="border:1px black solid">
                                <td style="border:1px black solid">入库单号</td>
                            ...
                            <tr style="border:1px black solid">
                                <td style="border:1px black solid">供应商</td>
                            ...
                            <tr style="border:1px black solid">
                                <td style="border:1px black solid" colspan="2">发票号</td>
                                <td style="border:1px black solid" colspan="2"><%=inventorydetail.invoicecode %></td>
                            </tr>
                        </table>
    ...
    <script> 
        $(function () {
            ...
            for (var i = 1; i < count; i++) {
                title = title + parseFloat($("table").eq(1).find("tr").eq(i).find("td").eq(7).text());
            }
            $("#count").val(title);
        });
		...
		LODOP=getLodop(document.getElementById('LODOP'),document.getElementById('LODOP_EM1'));  
            ...
            LODOP.ADD_PRINT_TEXT(50, 250, 980, 580, "上海闵行颛桥社区卫生服务中心 入库单");
            LODOP.SET_PRINT_TEXT_STYLE(1, "黑体", 20, 1, 0, 0, 1);
            LODOP.ADD_PRINT_HTM(88, 20, 1050, 650, strFormHtml);
            LODOP.ADD_PRINT_TEXT(50, 25, 980, 580, "入库金额:"+title);
        };
        </script>
