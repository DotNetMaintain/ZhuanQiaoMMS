        ...
        public static Hashtable GetWebControls(Control page)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                if (control != null)
                {
                    ...
                    {
                        HtmlInputFile txtFile = (HtmlInputFile)control;
                        ht[txtFile.ID] = txtFile.Value.Trim();
                    }
                    if (control is HtmlInputRadioButton )
                    {
                        HtmlInputRadioButton txtRadio = (HtmlInputRadioButton)control;
                        ht[txtRadio.Name] = txtRadio.Value.Trim();
                    }
